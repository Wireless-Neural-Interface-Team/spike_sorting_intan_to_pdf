...
class PipelineGUI(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.protocol_freq_min.setRange(0.1, 20000)
        self.protocol_freq_min.setValue(400)
        self.protocol_freq_min.setDecimals(2)
        self.protocol_freq_min.setSingleStep(0.1)
        ...
        self.protocol_freq_max.setRange(0.1, 20000)
        self.protocol_freq_max.setValue(5000)
        self.protocol_freq_max.setDecimals(2)
        self.protocol_freq_max.setSingleStep(0.1)
